package com.fmi.ordering.config.properties;
...
import static com.fmi.ordering.core.util.ToolUtil.getTempPath;
import static com.fmi.ordering.core.util.ToolUtil.isEmpty;
 ...
 */
@Component
@ConfigurationProperties(prefix = OrderingProperties.PREFIX)
