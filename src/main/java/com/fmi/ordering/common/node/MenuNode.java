package com.fmi.ordering.common.node;

import com.fmi.ordering.common.constant.Const;
import com.fmi.ordering.common.constant.state.IsMenu;
...
public class MenuNode implements Comparable {
    ...
    public static List<MenuNode> buildTitle(List<MenuNode> nodes) {
        ...
        OrderingProperties orderingProperties = SpringContextHolder.getBean(OrderingProperties.class);
