package com.fmi.ordering.core.template.engine.base;
 ...
 */
public abstract class OrderingTemplateEngine extends AbstractTemplateEngine {

    protected GroupTemplate groupTemplate;

    public OrderingTemplateEngine() {
        initBeetlEngine();
    }
