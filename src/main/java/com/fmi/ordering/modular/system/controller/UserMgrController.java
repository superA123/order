...
import com.fmi.ordering.common.constant.state.ManagerStatus;
import com.fmi.ordering.common.constant.tips.Tip;
...
public class UserMgrController extends BaseController {
    ...
    public String upload(@RequestPart("file") MultipartFile picture) {
        ...
        try {
            String fileSavePath = orderingProperties.getFileUploadPath();
